  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/devopsold/platformForm/list",
          delete: "/devopsold/platformForm/delete",
          deleteBatch: "/devopsold/platformForm/deleteBatch",
          exportXlsUrl: "/devopsold/platformForm/exportXls",
          importExcelUrl: "devopsold/platformForm/importExcel",
