        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="平台路径" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['serversPlatformDir']" placeholder="请输入平台路径"  ></a-input>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'serversIp','serversPlatformName','serversPlatformDir'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'serversIp','serversPlatformName','serversPlatformDir'))
      },
    }
  }
</script>